  ...
  const saveData = () => {
    if (
      ...
      if (
        ...
        Alert.alert('Warning', 'Nothing to update!', [
            {
              text: 'OK',
            },
          ]);
    ...
    <View style={styles.mainContainer}>
      <ScrollView contentContainerStyle={styles.scroll}>
        <View style={styles.imageContainer}>
          ...
          <InputComponent
            placeholder="Whatsapp number (ex : +6214885957892)"
          ...
          />
          <InputComponent
            placeholder="Instagram number (ex : +6214885957892)"
          ...
          />
          <InputComponent
            placeholder="Facebook number (ex : +6214885957892)"
